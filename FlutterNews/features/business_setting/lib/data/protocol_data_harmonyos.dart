/// 协议数据类 
class ProtocolDataHarmonyOS {
  ProtocolDataHarmonyOS._();

  /// 用户协议HTML内容 
  static const String userProtocol = '''
<html lang="zh-CN" id="container">
<head>
    <meta charset="UTF-8">
...
<body class="font-inter bg-gray-50 text-gray-800 min-h-screen flex flex-col">
  ...
  /// 隐私协议HTML内容 
  static const String privacyProtocol = userProtocol;

  /// 第三方信息共享清单HTML内容 
  static const String thirdPartyInfo = userProtocol;

  /// 个人信息收集清单HTML内容
  static const String personalInfoCollection = userProtocol;
}
