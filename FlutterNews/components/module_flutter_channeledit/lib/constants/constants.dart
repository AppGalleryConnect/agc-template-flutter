...
class Constants {
  ...
  static const Color SORT_EDIT_BACKGROUNDCOLOR =
      Color.fromARGB(255, 229, 226, 226);
  static const Color SORT_EDIT_TEXT_COLOR = Color(0xFF5C79D9);
  static const Color TAB_BAR_TEXT_COLOR = Color(0xFF007DFF);

  static const String deleteImage =
      'packages/module_flutter_channeledit/assets/delete.svg';
  static const String addImage =
      'packages/module_flutter_channeledit/assets/add.svg';
  static const String moreImage =
      'packages/module_flutter_channeledit/assets/tab_more.svg';
  static const String searchImage =
      'packages/module_flutter_channeledit/assets/ic_search_simple.svg';
}
